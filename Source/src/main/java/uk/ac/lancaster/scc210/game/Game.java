...
public class Game extends StateBasedGame {
    ...
    public Game() {
        ...
        try {
            ...
            SpaceShipPrototypeManager spaceShipManager = new SpaceShipPrototypeManager(animationManager, soundBufferManager, bulletPool, spaceShipDeserialiser.getSerialised());
