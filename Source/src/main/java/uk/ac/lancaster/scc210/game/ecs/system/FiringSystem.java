            ...
            if (Keyboard.isKeyPressed(Keyboard.Key.SPACE) || ControllerButton.A_BUTTON.isPressed()) {
               ...
               for(int i = 0; i < 8; i++)
               {
                ...
                Vector2f[] coordonates = new Vector2f[8];
                 ...
                 coordonates[1] = new Vector2f( startPoint +equalDistance/2 ,  - difference);
                 coordonates[2] = new Vector2f(startPoint/2 + equalDistance , startPoint);
                 coordonates[3] = new Vector2f(startPoint + equalDistance + difference  , startPoint + equalDistance/2);
                 coordonates[4] = new Vector2f( equalDistance,  equalDistance);
                 coordonates[5] = new Vector2f(-startPoint + equalDistance/2 , equalDistance + difference );
                 coordonates[6] = new Vector2f( -startPoint, width - startPoint);
                 coordonates[7] = new Vector2f(-startPoint - difference , -startPoint + equalDistance/2);
